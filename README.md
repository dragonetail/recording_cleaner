...
1. 基本原则
   ...
   - 生成Flutter代码时，永远参照知识库【docs.flutter.cn】使用最新的代码实现方法
   - 生成UI代码时，永远参照知识库【m3.material.io】使用最新的规范和配置方法
   - 代码生成时，优先使用Flutter官方推荐的包和插件
   - 遵循Material Design 3的设计规范
   - 保持代码的清晰和一致性
   - 确保跨平台兼容性
...
2. 代码生成规范
   ...
   - 新功能必须由用户发起或确认
   - 已有功能不得改变设计初衷
   - 允许修改：Bug修复、健壮性强化、日志补充、注释完善、代码重构
   - 修改原则：一次修改要完整，主动关联修正，避免遗漏代码

3. 自动化管理
   - 代码管理：自动格式化、提交、推送、版本控制
   - 文档管理：自动更新README、生成文档、补充注释
   - 质量管理：自动检查问题、修复错误、运行测试、生成报告
