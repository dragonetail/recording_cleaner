...
P _contactModelDeserializeProp<P>(
  ...
  switch (propertyId) {
    case 0:
      return (_ContactModelcategoryValueEnumMap[
...
const _ContactModelcategoryEnumValueMap = {
  'none': 0,
  'family': 1,
  'friend': 2,
  'colleague': 3,
...
const _ContactModelcategoryValueEnumMap = {
  0: ContactCategory.none,
  1: ContactCategory.family,
  2: ContactCategory.friend,
  3: ContactCategory.colleague,
  4: ContactCategory.customer,
  5: ContactCategory.other,
};
...
extension ContactModelByIndex on IsarCollection<ContactModel> {
  ...
  ContactModel? getByIdSync(String id) {
  ...
  Future<List<ContactModel?>> getAllById(List<String> idValues) {
    final values = idValues.map((e) => [e]).toList();
    return getAllByIndex(r'id', values);
  }

  List<ContactModel?> getAllByIdSync(List<String> idValues) {
    final values = idValues.map((e) => [e]).toList();
  ...
  Future<Id> putById(ContactModel object) {
    return putByIndex(r'id', object);
  }

  Id putByIdSync(ContactModel object, {bool saveLinks = true}) {
    return putByIndexSync(r'id', object, saveLinks: saveLinks);
  }

  Future<List<Id>> putAllById(List<ContactModel> objects) {
    return putAllByIndex(r'id', objects);
  }

  List<Id> putAllByIdSync(List<ContactModel> objects, {bool saveLinks = true}) {
...
extension ContactModelQueryWhereSort
  ...
  QueryBuilder<ContactModel, ContactModel, QAfterWhere> anyName() {
    return QueryBuilder.apply(this, (query) {
...
extension ContactModelQueryWhere
  ...
  QueryBuilder<ContactModel, ContactModel, QAfterWhereClause> nameGreaterThan(
    String name, {
    bool include = false,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<ContactModel, ContactModel, QAfterWhereClause> nameLessThan(
    String name, {
    bool include = false,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<ContactModel, ContactModel, QAfterWhereClause> nameBetween(
    String lowerName,
    String upperName, {
    bool includeLower = true,
    bool includeUpper = true,
  ...
  QueryBuilder<ContactModel, ContactModel, QAfterWhereClause> nameStartsWith(
      String NamePrefix) {
    return QueryBuilder.apply(this, (query) {
      return query.addWhereClause(IndexWhereClause.between(
        indexName: r'name',
  ...
  QueryBuilder<ContactModel, ContactModel, QAfterWhereClause> nameIsEmpty() {
    return QueryBuilder.apply(this, (query) {
      return query.addWhereClause(IndexWhereClause.equalTo(
        indexName: r'name',
        value: [''],
  ...
  QueryBuilder<ContactModel, ContactModel, QAfterWhereClause> nameIsNotEmpty() {
    return QueryBuilder.apply(this, (query) {
      if (query.whereSort == Sort.asc) {
        return query
...
extension ContactModelQueryFilter
  ...
  QueryBuilder<ContactModel, ContactModel, QAfterFilterCondition>
      categoryEqualTo(ContactCategory value) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<ContactModel, ContactModel, QAfterFilterCondition>
      categoryBetween(
    ContactCategory lower,
    ContactCategory upper, {
    bool includeLower = true,
    bool includeUpper = true,
  }) {
    return QueryBuilder.apply(this, (query) {
...
extension ContactModelQuerySortBy
  ...
  QueryBuilder<ContactModel, ContactModel, QAfterSortBy> sortByCategory() {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<ContactModel, ContactModel, QAfterSortBy> sortByIsProtected() {
    return QueryBuilder.apply(this, (query) {
...
extension ContactModelQuerySortThenBy
  ...
  QueryBuilder<ContactModel, ContactModel, QAfterSortBy> thenByCategory() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'category', Sort.asc);
    });
  }
  ...
  QueryBuilder<ContactModel, ContactModel, QAfterSortBy> thenByIsProtected() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'isProtected', Sort.asc);
    });
  }
...
extension ContactModelQueryWhereDistinct
  ...
  QueryBuilder<ContactModel, ContactModel, QDistinct> distinctByIsProtected() {
    return QueryBuilder.apply(this, (query) {
...
extension ContactModelQueryProperty
  ...
  QueryBuilder<ContactModel, ContactCategory, QQueryOperations>
      categoryProperty() {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<ContactModel, String, QQueryOperations> idProperty() {
    return QueryBuilder.apply(this, (query) {
      return query.addPropertyName(r'id');
    });
  }

  QueryBuilder<ContactModel, bool, QQueryOperations> isProtectedProperty() {
    return QueryBuilder.apply(this, (query) {
